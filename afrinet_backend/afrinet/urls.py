...
from .views import (
    ...
    PackageDistributionDataAPIView,
    PackageListCreateView,
    InitiatePaymentView,
    PasswordResetConfirmAPIView,
    PasswordResetRequestAPIView,
    PaymentChartDataAPIView,
    UserActivityDataAPIView,
    UserLoginAPIView,
    UserLogoutAPIView,
...
urlpatterns = [
    ...
    path('auth/login/', UserLoginAPIView.as_view(), name='login'),
     path('auth/request-reset/', PasswordResetRequestAPIView.as_view()),
    path('auth/verify-code/', VerifyResetCodeAPIView.as_view()),
    path('auth/reset-password/', PasswordResetConfirmAPIView.as_view()),
    ...
    path('dashboard/payment-chart/', PaymentChartDataAPIView.as_view()),
    path('dashboard/user-activity/', UserActivityDataAPIView.as_view()),
    path('dashboard/package-distribution/', PackageDistributionDataAPIView.as_view()),
